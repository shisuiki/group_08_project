...
can still select this directory explicitly for legacy/demo/debug/import/export
flows.
...
store for FeaturePlant, the frontend adapter, and research export.
...
backtesting, frontend demos, and research export only when those workflows
explicitly choose NDJSON.
